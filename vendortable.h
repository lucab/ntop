static VendorInfo vendorInfo [] = {
   ...
   { 0x000280, "Mu Net, Inc." },
   { 0x000281, "RedM (Communications) Ltd." },
   ...
   { 0x00054F, "Garmin International, Inc." },
   ...
   { 0x000607, "OmniDirectional Control Technology Inc." },
   { 0x000608, "AtSky SAS" },
   ...
   { 0x00068B, "Air Runner Technologies, Inc." },
   ...
   { 0x0006C8, "Sumitomo Metal Industries, Ltd." },
   ...
   { 0x0007D1, "Spectrum Processing (Inc.)" },
   ...
   { 0x002067, "IEEE OUI ADMINISTRATOR" },
   { 0x002068, "ISDYNE" },
   ...
   { 0x005047, "HONEYWELL DEFENSE AVIONICS" },
   { 0x005048, "INFOLIBRIA" },
   ...
   { 0x00A085, "IEEE STANDARDS DEPARTMENT" },
   ...
   { 0x1100AA, "IEEE STANDARDS OFFICE" },
   ...
   { 0xACDE48, "IEEE Registration Authority" },
   { 0x0, NULL }
};
